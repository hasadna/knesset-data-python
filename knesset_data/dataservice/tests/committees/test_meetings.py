...
class TestCommitteeMeetings(unittest.TestCase):
    ...
    def test_table_schema(self):
        ...
        self.assertEqual(meeting.all_schema_field_values(), OrderedDict([('id', 1),
                                                                         ...
                                                                         ('title', None), ('session_content', None),
                                                                         ('url', 'mock url 1'), ('location ', None),
                                                                         ('place ', None), ('meeting_stop ', None),
                                                                         ...
                                                                         ('agenda_invite ', None), ('note ', None),
                                                                         ('start_datetime ', None), ('topid_id ', None),
                                                                         ('creation_date ', None),
                                                                         ('streaming_url ', None),
                                                                         ('meeting_start ', None), ('is_paused ', None),
                                                                         ('date_order ', None), ('date ', None),
                                                                         ('day ', None), ('month ', None),
                                                                         ('material_id ', None),
                                                                         ('material_committee_id ', None),
                                                                         ('material_expiration_date ', None),
                                                                         ('material_hour ', None), ('old_url ', None),
